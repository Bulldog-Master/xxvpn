...
DROP POLICY IF EXISTS "Restrict devices to own user only" ON public.devices;
...
DROP POLICY IF EXISTS "Only super admins can view device access audit" ON public.device_access_audit;
...
DROP POLICY IF EXISTS "Service role can insert device access audit" ON public.device_access_audit;
